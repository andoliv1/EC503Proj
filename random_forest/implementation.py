...
# Example 
num_trees = 10
[trainccr, testccr] = ccr(X_Train, Y_Train, X_Test, Y_Test, classifier, num_trees, 1)
...
plt.contourf(X1, X2, bagged_trees_pred((np.array([X1.ravel(), X2.ravel()]).T)).reshape(X1.shape), 
